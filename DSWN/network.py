...
# --------------------------------------------------------------------------------
#                   Densely Self-Guided Wavelet Network (DSWN)
# --------------------------------------------------------------------------------
class DSWN(nn.Module):
    def __init__(self, opt):
        ...
        self.D4 = Conv2dLayer(in_channels = 320, out_channels = 3, kernel_size=3, stride = 1, padding = 1, dilation = 1, pad_type = opt.pad, norm = 'none', activation = 'tanh')
    ...
    def forward(self, x):
        ...
        res_part5 = self.D4(res_part4)
        res_part = noisy - res_part5
